    ...
    >
      ...
      {meetPath && (
        <div className="px-4 pb-2">
          <button
            onClick={copyLink}
            className="flex items-center gap-1.5 text-[11px] text-zinc-500 hover:text-purple-400 transition group"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          {canArchive && onArchive && (
            <button
              ...
              className="p-1 rounded-lg text-zinc-600 hover:text-zinc-400 hover:bg-zinc-800/60 transition"
              title="Archive"
            >
