  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-zinc-100 flex flex-col">
      ...
      <div className="max-w-2xl mx-auto w-full px-4 sm:px-6 py-8 space-y-8">
        ...
        {/* Calendar Context for the Next Few Weeks */}
        <section>
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center">
              ...
              <InfoBubble text="Give your agent context about your upcoming schedule — travel, events, availability changes. This helps Envoy make smarter scheduling decisions for the next few weeks." />
            </div>
