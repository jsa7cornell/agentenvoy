...
export default function TunerPage() {
  ...
  const canGoPrev = weekStart > today; // don't go before current week
  const canGoNext = weekStart < nextWeekStart; // 2-week window
  ...
  function shiftWeek(dir: number) {
    ...
    if (dir > 0 && next > nextWeekStart) return;
    setWeekStart(next);
  }
    ...
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {!connected ? (
          ...
          <>
            {/* Weekly calendar — takes upper portion */}
            ...
            {/* Chat panel — takes lower portion */}
            <div className="h-[40vh] min-h-[200px] flex flex-col shrink-0">
              {/* Chat messages */}
