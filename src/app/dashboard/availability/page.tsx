...
export default function AvailabilityPage() {
  ...
  // Scope of the override for recurring events — "instance" = just this one,
  // "series" = all instances of the recurring master. Defaults to "instance"
  // (seeded from the existing override when one is set). Non-recurring events
  // ignore this — the scope is always "instance".
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      {/* Scope picker — only for recurring instances, and only
                          when there's a pending override to save. Past
                          instances are never affected; a series override on
                          this master won't retroactively change slots that
                          already passed. */}
            ...
            {confirmingCancel && clickedSession ? (
              ...
              <div className="flex gap-2 mt-1">
                {(() => {
                  ...
                  // For series scope, persist against the master id so the
                  // override matches every instance (and any future moved
                  // instance that retains the same recurringEventId).
                  const saveEventId =
