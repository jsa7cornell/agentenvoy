...
- create_link: Create a new invite → {"action":"create_link","params":{"inviteeName":"...","topic":"...","format":"...","duration":45,"minDuration":30,"isVip":true,"preferredDays":["Mon"],"dateRange":{"start":"YYYY-MM-DD","end":"YYYY-MM-DD"}}}
