...
General strategies for effective negotiation, regardless of domain.

## Progressive Disclosure (3 Tiers)

Never show all options at once. Start narrow, expand only when needed.
...
- When the guest suggests alternative times, check them against the host's calendar and rules.
- If the counter-proposal works: confirm immediately.
- If it partially works: "Thursday works but 2pm is taken — I have 3pm or 4pm open that day."
- If it doesn't work: explain briefly why, then offer the closest alternative.
